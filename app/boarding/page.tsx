...
import { useBoardingPools } from '../../hooks/useBoarding';
  ...
  return (
    <div className="animate-in px-10 py-10 max-w-[1200px] mx-auto">
      ...
      <div className="flex justify-between items-end mb-8">
        ...
        <Link
          href="/boarding/create"
          className="px-5 py-2.5 bg-gradient-to-br from-primary to-primary-dark text-bg-base border-none rounded-lg font-heading text-[11px] font-bold cursor-pointer tracking-[1px] shadow-[0_2px_15px_rgba(136,192,255,0.25)] hover:shadow-[0_4px_25px_rgba(136,192,255,0.4)] transition-shadow no-underline"
        >
          + CREATE
        </Link>
      </div>
      ...
      <BoardingList pools={pools} loading={loading} />
    </div>
  );
}
